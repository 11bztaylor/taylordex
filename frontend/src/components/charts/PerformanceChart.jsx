...
const PerformanceChart = ({ data, title, color = 'green', height = 200, description }) => {
  ...
  // Create SVG path
  const width = 100;
  const chartHeight = height - 80; // Leave more space for labels and description
  ...
  // Future: Add proper threshold-based analysis here
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex justify-between items-start">
        ...
        {data.length > 0 && (
          <div className="text-right">
            <span className={`text-lg font-semibold ${selectedColor}`}>
      ...
      {/* Future: Add proper threshold-based insights here */}
      {/* Removed misleading interpretations - need real thresholds and service-specific logic */}
    </div>
  );
};
